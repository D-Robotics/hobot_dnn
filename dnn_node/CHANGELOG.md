...
------------------
1. 新增 ultralytics_yolo 解析方法, 支持 yolo26 模型推理。

tros_2.6.0 (2025-12-25)
------------------
1. 新增 RDK S600 dnn 适配。

tros_2.5.9 (2025-10-14)
------------------
1. 修复 X5 fcos 推理失败的问题。

tros_2.5.8 (2025-10-16)
------------------
1. 修复 dnn_node 推理时间计算错误的问题。
...
------------------
1. 修复 x3 yolov5 模型推理失败问题。

tros_2.5.2 (2025-06-30)
------------------
1. 修复 x3 ssd 模型推理后处理失败问题。

tros_2.5.1 (2025-06-23)
------------------
1. 适配 deeplabv3 分割模型。
...
------------------
1. 修复yolov8-seg模型后处理中box越界导致的crash问题。

tros_2.4.1 (2024-11-18)
------------------
1. 修复多线程推理中推理耗时计算错误的问题。
...
2. 更新YOLOv8和YOLOv10模型后处理。
3. 修复了YOLOv5中多线程处理每一层后只输出一个框的bug。
4. 更新YOLOv8Seg模型后处理。
5. 修复了SSD中未反量化处理导致的结果错误的bug。
